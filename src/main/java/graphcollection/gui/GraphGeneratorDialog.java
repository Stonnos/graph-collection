...
public class GraphGeneratorDialog extends JDialog {
    ...
    public GraphView graphView() {
         ...
         switch (graphView.getSelectedIndex()) {
             case 0: view = GraphView.Matrix_Graph; break;
             case 1: view = GraphView.Hash_Set_Graph; break;
             case 2: view = GraphView.Tree_Set_Graph; break;
             case 3: view = GraphView.List_Set_Graph; break;
             case 4: view = GraphView.Sorted_Set_Graph; break;
         }
         return view;
    }
}
